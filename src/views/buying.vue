...
<div class="product-info">
    <span class="price-up"><small>￥</small>{{list[$route.query.index].price}}</span>
    <span class="price-down"><small>￥</small>{{list[$route.query.index].priceNot}}</span>
...
import {mapState} from 'vuex'
    export default {
        ...
        methods: {
         ...
         onClickButton(){
            //  list[this.$route.query.index].num +=1
         }
        },
        created(){
